  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden bg-primary">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center animate-on-scroll stagger-1">
      ...
      <section className="bg-slate-50 py-32 rounded-[4rem] mx-6">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-24 animate-on-scroll stagger-1">
          ...
          <div className="grid lg:grid-cols-2 gap-16 mb-24">
            <div className="animate-on-scroll stagger-2">
              <div className="bg-white p-12 rounded-[3rem] shadow-xl border border-white relative overflow-hidden group h-full hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
                ...
                <p className="text-xl text-slate-500 font-light leading-relaxed italic relative z-10">
            ...
            <div className="animate-on-scroll stagger-3">
              <div className="bg-primary p-12 rounded-[3rem] shadow-xl relative overflow-hidden group h-full hover:shadow-2xl hover:shadow-primary/30 hover:-translate-y-2 transition-all duration-300">
                ...
                <p className="text-xl text-slate-300 font-light leading-relaxed italic relative z-10">
                  {t('about.vision.desc')}
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative border-t-2 border-slate-100 pt-16 mt-8">
            {[
              ...
              <div key={i} className={`flex-1 relative group text-center md:text-left animate-on-scroll stagger-${i + 1}`}>
                ...
                <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 group-hover:bg-white group-hover:shadow-2xl group-hover:-translate-y-2 transition-all duration-500 h-full">
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-5 space-y-10">
              <div className="grid grid-cols-2 gap-6">
                {[
                  ...
                  <div key={i} className={`animate-on-scroll stagger-${i + 1}`}>
                    <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all group h-full">
              ...
              <button
                ...
                className="pulse-glow-btn w-full bg-accent text-primary py-5 rounded-[2rem] font-black text-xs uppercase tracking-[0.2em] transition-all shadow-xl group flex items-center justify-center gap-4 hover:scale-[1.02] active:scale-[0.98]"
              >
                {t('about.cta.title')}
